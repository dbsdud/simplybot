...
public class UserDTO {
	...
	public String getGoogle_user_yn() {
		return google_user_yn;
	}
	public void setGoogle_user_yn(String google_user_yn) {
		this.google_user_yn = google_user_yn;
	}
