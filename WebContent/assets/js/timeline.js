...
TL.Util = {
	...
	extend: function (t) {
		for (var e, i = Array.prototype.slice.call(arguments, 1), n = 0, a = i.length; a > n; n++) e = i[n] || {},
	...
	getUrlVars: function (t) {
		...
		for (var s = 0; s < n.length; s++) i = n[s].split("="),
		a.push(i[0]),
		a[i[0]] = i[1];
		return a
	},
...
function (t) {
	var e = function () {
		...
		G.init = function (t, i) {
			var n;
			if (!t) return G.Z();
			if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && A.test(t)) n = G.fragment(t, RegExp.$1, i),
			t = null;
			else {
				...
				t = null;
				else if (A.test(t)) n = G.fragment(t.trim(), RegExp.$1, i),
				t = null;
				else {
					if (i !== L) return $(i).find(t);
					n = G.qsa(S, t)
		...
		$.fn = {
			...
			attr: function (t, e) {
				...
				return "string" == typeof t && e === L ? 0 == this.length || 1 !== this[0].nodeType ? L: "value" == t && "INPUT" == this[0].nodeName ? this.val() : !(i = this[0].getAttribute(t)) && t in this[0] ? this[0][t] : i: this.each(function (i) {
					if (1 === this.nodeType) if (a(t)) for (w in t) g(this, w, t[w]);
			...
			toggleClass: function (t, e) {
				return t ? this.each(function (i) {
					var n = $(this),
					a = f(this, t, i, v(this));
					a.split(/\s+/g).forEach(function (t) { (e === L ? !n.hasClass(t) : e) ? n.addClass(t) : n.removeClass(t)
					})
				}) : this
			},
			scrollTop: function (t) {
				if (this.length) {
					...
					return t === L ? e ? this[0].scrollTop: this[0].pageYOffset: this.each(e ?
					function () {
						this.scrollTop = t
					}: function () {
			...
			scrollLeft: function (t) {
				if (this.length) {
					...
					return t === L ? e ? this[0].scrollLeft: this[0].pageXOffset: this.each(e ?
					function () {
						this.scrollLeft = t
					}: function () {
...
TL.Class.extend = function (t) {
	...
	t.options && n.options && (t.options = TL.Util.extend({},
	n.options, t.options)),
	TL.Util.extend(n, t),
...
TL.Events = {
	...
	removeEventListener: function (t, e, i) {
		...
		for (var n = 0, a = this._tl_events, s = a[t].length; s > n; n++) if (a[t][n].action === e && (!i || a[t][n].context === i)) return a[t].splice(n, 1),
		this;
		return this
	},
...
TL.LoadIt = function (t) {
	...
	function a(a, d, u, m, _) {
		...
		else for (p = 0, f = d.length; f > p; ++p) c[a].push({
			urls: [d[p]],
		...
		if (!h[a] && (v = h[a] = c[a].shift())) {
			for (l || (l = t.head || t.getElementsByTagName("head")[0]), y = v.urls, p = 0, f = y.length; f > p; ++p) T = y[p],
			w ? g = r.gecko ? e("style") : e("link", {
				href: T,
				rel: "stylesheet"
			}) : (g = e("script", {
				src: T
			}), g.async = !1),
			g.className = "lazyload",
			g.setAttribute("charset", "utf-8"),
			r.ie && !w ? g.onreadystatechange = function () {
			...
			b.push(g);
			for (p = 0, f = b.length; f > p; ++p) l.appendChild(b[p])
		}
	}
	function s(t) {
		var e;
		try {
			...
			return d += 1,
			void(200 > d ? setTimeout(function () {
				s(t)
			},
			50) : e && i("css"))
		}
...
TL.TimelineConfig = TL.Class.extend({
	...
	initialize: function (t) {
		if (this.title = "", this.scale = "", this.events = [], this.eras = [], this.event_dict = {},
		this.messages = {
			errors: [],
			warnings: []
		},
	...
	validate: function () { ("undefined" == typeof this.events || "undefined" == typeof this.events.length || 0 == this.events.length) && this.logError("Timeline configuration has no events.");
	...
	l = function (i, n) {
		...
		if (s) {
			try {
				...
				a.logError("NetworkError" == l.name ? new t.Error("network_err") : "TL.Error" == l.name ? l: new t.Error("unknown_read_err", l.name)),
				void n(a)
			}
			if (a = new t.TimelineConfig(r), r.errors) for (var h = 0; h < r.errors.length; h++) a.logError(r.errors[h]);
			n(a)
		} else t.ajax({
			url: i,
			dataType: "json",
...
window.tlanimate = function () {
	...
	function u(t, e) {
		...
		for (n = 1; a > n; ++n) for (i = 0; a - n > i; ++i) s[i][0] = (1 - e) * s[i][0] + e * s[parseInt(i + 1, 10)][0],
		s[i][1] = (1 - e) * s[i][1] + e * s[parseInt(i + 1, 10)][1];
		return [s[0][0], s[0][1]]
	}
	function m(t, e, i) {
		var n, a, s, o, r = [];
		for (n = 0; 6 > n; n++) s = Math.min(15, parseInt(e.charAt(n), 16)),
		o = Math.min(15, parseInt(i.charAt(n), 16)),
		a = Math.floor((o - s) * t + s),
		a = a > 15 ? 15 : 0 > a ? 0 : a,
		r[n] = a.toString(16);
		return "#" + r.join("")
	}
	...
	function f(t, e) {
		...
		return c.apply(d, [f, function (t, n, a) {
			for (i = d.length; i--;) {
				...
				for (var o in e) n = _(t, L, y, T, o, i),
				"transform" == o ? d[i].style[A] = s(n) : "opacity" != o || U ? d[i].style[l(o)] = n: d[i].style.filter = "alpha(opacity=" + 100 * n + ")"
			}
		},
		m, g])
	}
	...
	j = g.defaultView && g.defaultView.getComputedStyle ?
	function (t, e) {
		e = "transform" == e ? A: e,
		e = l(e);
		var i = null,
	...
	O = function () {
		return v.requestAnimationFrame || v.webkitRequestAnimationFrame || v.mozRequestAnimationFrame || v.msRequestAnimationFrame || v.oRequestAnimationFrame ||
		function (t) {
...
TL.Dom = {
	...
	getPosition: function (t) {
		for (var e = {
			x: 0,
			y: 0
		}; t && !isNaN(t.offsetLeft) && !isNaN(t.offsetTop);) e.x += t.offsetLeft,
		e.y += t.offsetTop,
		t = t.offsetParent;
		return e
	},
...
TL.DomEvent = {
	addListener: function (t, e, i, n) {
		...
		if (!t[s]) {
			...
			else if ("addEventListener" in t) if ("mousewheel" === e) t.addEventListener("DOMMouseScroll", o, !1),
...
TL.Date = TL.Class.extend({
	...
	findBestFormat: function (t) {
		for (var e = TL.Date.DATE_PARTS, i = 0; i < e.length; i++) if (this.data[e[i]]) return t ? t in TL.Date.BEST_DATEFORMATS || (t = "short") : t = "base",
		TL.Date.BEST_DATEFORMATS[t][e[i]];
		return ""
	},
...
TL.Message = TL.Class.extend({
	...
	_updateMessage: function (t) {
		this._el.message.innerHTML = t ? t: this._("loading"),
...
TL.Media = TL.Class.extend({
	...
	updateMeta: function () { ! this.data.credit && this.data.credit_alternate && (this._el.credit = TL.Dom.create("div", "tl-credit", this._el.content_container), this._el.credit.innerHTML = this.data.credit_alternate, this.options.credit_height = this._el.credit.offsetHeight),
...
TL.Media.DailyMotion = TL.Media.extend({
	...
	_loadMedia: function () {
		...
		this.media_id = this.data.url.match("video") ? this.data.url.split("video/")[1].split(/[?&]/)[0] : this.data.url.split("embed/")[1].split(/[?&]/)[0],
...
TL.Media.GoogleDoc = TL.Media.extend({
	...
	_loadMedia: function () {
		var t;
		if (this._el.content_item = TL.Dom.create("div", "tl-media-item tl-media-iframe", this._el.content), this.data.url.match("open?id=")) this.media_id = this.data.url.split("open?id=")[1],
...
TL.Media.Spotify = TL.Media.extend({
	...
	_updateMediaDisplay: function () {
		...
		e = 0,
		i = 0;
		t = TL.Browser.mobile ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30,
		this._el.content_item.style.maxHeight = "none",
		trace(t),
		trace(this.options.width),
		t > this.options.width ? (trace("height is greater"), e = this.options.width + 80 + "px", i = this.options.width + "px") : (trace("width is greater"), trace(this.options.width), e = t + "px", i = t - 80 + "px"),
		this.player.style.width = i,
		this.player.style.height = e,
		this._el.credit && (this._el.credit.style.width = i),
		this._el.caption && (this._el.caption.style.width = i)
	},
	_stopMedia: function () {}
}),
...
TL.Media.TwitterEmbed = TL.Media.extend({
	...
	createMedia: function (t) {
		...
		o = a.split('">')[1].split("</a>")[0],
		i = i.replace(/<a href/gi, '<a target="_blank" href'),
		i.includes("pic.twitter.com") ? (twttr.ready(function () {
	...
	createCardContent: function () { !
		function (t, e) {
			...
			if (!e.getElementById(i)) {
				t.embedly = t.embedly ||
				function () { (t.embedly.q = t.embedly.q || []).push(arguments)
				};
...
TL.Media.Wikipedia = TL.Media.extend({
	...
	_loadMedia: function () {
		...
		this.media_id = this.media_id.replace(" ", " "),
...
TL.Slide = TL.Class.extend({
	...
	_updateDisplay: function (t, e, i) {
		...
		this.options.height = e ? e: this._el.container.offsetHeight,
...
TL.StorySlider = TL.Class.extend({
	...
	_createSlide: function (t, e, i) {
		...
		this._addSlide(n),
		0 > i ? this._slides.push(n) : this._slides.splice(i, 0, n)
	},
	_createSlides: function (t) {
		for (var e = 0; e < t.length; e++)"" == t[e].unique_id && (t[e].unique_id = TL.Util.unique_ID(6, "tl-slide")),
	...
	changeBackground: function (t) {
		...
		this._el.background.style.backgroundColor = t.color_value ? t.color_value: "transparent",
	...
	_updateDisplay: function (t, e, i, n) {
		...
		for (var o = 0; o < this._slides.length; o++) this._slides[o].updateDisplay(this.options.width, this.options.height, s),
	...
	_updateDrawSlides: function () {
		for (var t = this.options.layout, e = 0; e < this._slides.length; e++) this._slides[e].updateDisplay(this.options.width, this.options.height, t),
...
TL.TimeNav = TL.Class.extend({
	...
	_createMarker: function (t, e) {
		...
		this._addMarker(i),
		0 > e ? this._markers.push(i) : this._markers.splice(e, 0, i)
	},
	...
	_positionMarkers: function (t) {
		for (var e = 0; e < this._markers.length; e++) {
			...
			this._markers[e].setClass(t ? "tl-timemarker tl-timemarker-fast": "tl-timemarker"),
	...
	_createEra: function (t, e) {
		...
		this._addEra(i),
		0 > e ? this._eras.push(i) : this._eras.splice(e, 0, i)
	},
	_addEra: function (t) {
		t.addTo(this._el.marker_item_container),
	...
	_positionEras: function (t) {
		for (var e = 0, i = 0; i < this._eras.length; i++) {
			...
			this._eras[i].setClass(t ? "tl-timeera tl-timeera-fast": "tl-timeera"),
...
TL.TimeMarker = TL.Class.extend({
	...
	setActive: function (t) {
		this.active = t,
		this._el.container.className = this.active && this.has_end_date ? "tl-timemarker tl-timemarker-with-end tl-timemarker-active": this.active ? "tl-timemarker tl-timemarker-active": this.has_end_date ? "tl-timemarker tl-timemarker-with-end": "tl-timemarker"
	},
	addTo: function (t) {
		t.appendChild(this._el.container)
	},
	...
	setHeight: function (t) {
		...
		this._el.content.className = 30 >= t ? "tl-timemarker-content tl-timemarker-content-small": "tl-timemarker-content",
		56 >= t ? TL.DomUtil.addClass(this._el.content_container, "tl-timemarker-content-container-small") : TL.DomUtil.removeClass(this._el.content_container, "tl-timemarker-content-container-small"),
	...
	_initLayout: function () {
		...
		this.data.text.headline && "" != this.data.text.headline ? this._text.innerHTML = TL.Util.unlinkify(this.data.text.headline) : this.data.text.text && "" != this.data.text.text ? this._text.innerHTML = TL.Util.unlinkify(this.data.text.text) : this.data.media && this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = TL.Util.unlinkify(this.data.media.caption)),
		this.onLoaded()
	},
	_initEvents: function () {
...
TL.TimeScale = TL.Class.extend({
	...
	_computeRowInfo: function (t, e) {
		for (var i = [], n = 0, a = 0; a < t.length; a++) {
			...
			if ("undefined" == typeof s.row) if (null === e) s.row = i.length,
			i.push(s);
			else if (e > 0) s.row = i.length,
			i.push(s),
			e--;
			else {
	...
	_computePositionInfo: function (t, e, i) {
		...
		for (var n = [], a = !1, s = 0; s < t.length; s++) {
			...
			if (this._positions.push(o), "undefined" != typeof t[s].end_date) {
				...
				o.width = r - o.start,
				o.end = o.width > i ? o.start + o.width: o.start + i
			} else o.width = i,
			o.end = o.start + i;
...
TL.Timeline = TL.Class.extend({
	...
	initialize: function (t, e, i) {
		...
		this._el.container = "object" == typeof t ? t: TL.Dom.get(t), this._storyslider = {},
		this._style_sheet = new TL.StyleSheet, this._timenav = {},
		this._menubar = {},
		this._loaded = {
			storyslider: !1,
			timenav: !1
	...
	_calculateTimeNavHeight: function (t, e) {
		var i = 0;
		return t ? i = t: (this.options.timenav_height_percentage || e) && (i = Math.round(e ? this.options.height / 100 * e: this.options.height / 100 * this.options.timenav_height_percentage)),
	...
	_initLayout: function () {
		...
		this.options.storyslider_height = "portrait" == this.options.layout ? this.options.height - this.options.timenav_height - 1 : this.options.height - 1,
